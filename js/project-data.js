...
const PROJECTS = [
  ...
  },
  {
    ...
    description: "Four band-limited oscillators with cross-modulation and hard sync, dual routable filters, a 16-slot mod matrix, and a 16-step sequencer with per-step probability and ratchet — plus 74 factory presets and a seeded randomizer that builds whole new patches you can reproduce from a single number.",
    tech: ["16-slot mod matrix", "FM / PM / AM / ring mod", "Seeded patch randomizer", "74 factory presets"],
  ...
  },
  {
    ...
    title: "GLOCKWORK",
    category: "MALLET LAB",
    tagline: "An Orff and mallet instrument sound laboratory — xylophones, marimbas, vibraphones and stranger bars, all synthesized live.",
    description: "Twenty-two instrument models built from modal synthesis rather than samples: a bank of tuned partials, a noise-burst excitation shaped by mallet hardness, a resonant body formant and optional FM shimmer — with Orff scale lock and a worklet-clocked arpeggiator.",
    tech: ["Modal synthesis, no samples", "22 instrument models", "Orff scale lock", "Worklet-clocked arpeggiator"],
    repoUrl: "https://github.com/jtbartee/glockwork",
    liveUrl: "https://jtbartee.github.io/glockwork/",
    screenshot: "assets/projects/glockwork.png",
    accent: "#d98a3d",
  },
  {
    slug: "sideband",
    ...
    tagline: "A four-operator FM synthesizer and teaching oscilloscope, where every patch is a link you can paste to someone else.",
    description: "Four wavetable phase-modulation operators on an arbitrary modulation matrix, beside a real oscilloscope, a live spectrum analyser that labels the sidebands, and a routing diagram that lights up as sound moves through it.",
    tech: ["4-operator phase modulation", "Oscilloscope + spectrum analyser", "34 patches", "Shareable patch links"],
    repoUrl: "https://github.com/jtbartee/sideband",
    liveUrl: "https://jtbartee.github.io/sideband/",
    screenshot: "assets/projects/sideband.png",
    accent: "#5ad3c8",
  },
  {
