...
const PLUGINS = [
  ...
  },
  {
    ...
    version: "1.2.0",
    description: "Two warped, unison-capable wavetable oscillators with sub and noise, a ZDF state-variable filter, a 4-slot mod matrix, and a distortion / chorus / delay / reverb chain. 1.2 adds the RANDOM / MUTATE dice.",
    formats: ["VST3", "AU", "Standalone"],
    file: "downloads/SPECTRA-1.2.0-macOS.zip",
    size: "9.7 MB",
